        ...
        if (Status == 0):
            ...
            sendData = {'Verb':'GET',
                        ...
                        'Headers':{'Content-Type':'text/xml; charset=utf-8', \
                                   ...
                                   'Host':Parameters["Mode1"] + "?status=full:80", \
        ...
        if (self.httpConn != None and (self.httpConn.Connecting() or self.httpConn.Connected())):
            ...
            if self.runAgain <= 0:
                if (self.httpConn == None):
                    self.httpConn = Domoticz.Connection(Name = self.sProtocol + " Test",Transport = "TCP/IP",
                                                        Protocol = self.sProtocol,Address = Parameters["Address"],
