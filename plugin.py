...
class BasePlugin:
    ...
    def onStart(self):
        ...
        if (len(Devices) == 0):
            ...
            Domoticz.Device(Name = "Mode",Unit = 4,TypeName = "Selector Switch",Image = 16,Options = Options,
                            Used = 1).Create()
            ...
            Domoticz.Device(Name = "Fan Rate",Unit = 5,TypeName = "Selector Switch",Image = 7,Options = Options,
                            Used = 1).Create()
        ...
        self.httpConnSensorInfo = Domoticz.Connection(Name = "Sensor Info",Transport = "TCP/IP",Protocol = "HTTP",
    ...
    def onMessage(self,Connection,Data):
        ...
        if (Connection == self.httpConnControlInfo):
            ...
            Domoticz.Debug(
                "Power: " + power + "; Mode: " + mode + "; FanRate: " + f_rate + "; Target temperature: " + stemp)
