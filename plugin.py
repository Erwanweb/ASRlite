...
<plugin key="ASRlite" name="AC Aircon Smart Remote" author="MrErwan" version="0.0.1" externallink="https://github.com/Erwanweb/ASRlite.git">
    ...
    <params>
        ...
        <param field="Mode2" label="ASR Mac" width="200px" required="false" default=""/>
...
class BasePlugin:
    ...
    def onStart(self):
        ...
        if 2 not in Devices:
            Domoticz.Device(Name="On/Off", Unit=21, TypeName="Switch", Image=9, Used=1).Create()
    ...
    def onMessage(self,Connection,Data):
        ...
        if (Connection == self.httpConnControlInfo):
            ...
            position = dataDecoded.find("Index")
            index = dataDecoded[position + 7: position + 8]
            ...
            Domoticz.Debug(
                "mac: " + mac + ";Index: " + index + ";Power: " + onoff + "; Mode: " + mode + "; FanSpeed: " + fanspeed + "; AC Set temp: " + stemp)
    ...
    def onCommand(self,Unit,Command,Level,Color):
        ...
        if (Unit == 2):
            ...
            Devices[3].Update(nValue = self.powerOn,sValue = Devices[2].sValue)
            Devices[4].Update(nValue = self.powerOn,sValue = Devices[3].sValue)
            Devices[5].Update(nValue = self.powerOn,sValue = Devices[4].sValue)
    ...
    def buildCommandString(self):
        ...
        if (Devices[5].sValue < "16"):  # Set temp Lower than range
            ...
            requestUrl = requestUrl + Devices[4].sValue
