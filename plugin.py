        ...
        if (Connection == self.httpConnControlInfo):
            ...
            for remoteObject in jsonStatus["Remotes"]:
                ...
                if Parameters["Mode2"] == remoteObject["MACAddress"]:
                    ...
                    winpos = remoteObject["WindDirectionPosition"]
            ...
            if id > -1:
                ...
                Domoticz.Debug(
                    "Power: " + onoff + "; Mode: " + mode + "; FanSpeed:" + fanspeed + "; AC Set temp: " + str(stemp)+ "; Wmode: " + winmode + "; Wpos: " + str(winpos))
