...
class BasePlugin:
    ...
    def onMessage(self,Connection,Data):
        ...
        if (Connection == self.httpConnControlInfo):
            ...
            # Mode3 = mac@ of the ASR
            position = dataDecoded.find(Parameters["Mode2"])
            ...
            # Server SR index
            Devices[2].Update(nValue = 0,sValue = id)
            ...
            if (connex == "0"):
                ...
                Devices[6].Update(nValue = 0,sValue = stemp)
    ...
    def buildCommandString(self):
        ...
        # Select good Index of the ASR from 1 to 9
