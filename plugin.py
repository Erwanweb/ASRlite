...
class BasePlugin:
    ...
    def onStart(self):
        ...
        self.httpConnControlInfo = Domoticz.Connection(Name = "Set Control",Transport = "TCP/IP",Protocol = "HTTP",
    ...
    def buildCommandString(self):
        ...
        if Devices[3].sValue > "16":
            requestUrl = requestUrl + "16"  # Set Temp at Lower authorized by aircon
        Domoticz.Log("Aircon id 1 Set Temp requested is Lower than the Range")
        if Devices[3].sValue > "30":
        requestUrl = requestUrl + "30"  # Set Temp at Max authorized by aircon
        Domoticz.Log("Aircon id 1 Set Temp requested is Upper than the Range")
        if  # Set Temp is in the authorized range
        requestUrl = requestUrl + Devices[3].sValue  # Set Temp
