...
class BasePlugin:
    ...
    def onMessage(self,Connection,Data):
        ...
        if (Connection == self.httpConnControlInfo):
            ...
            stemp = dataDecoded[position + 13: position + 15]
        ...
        if (Devices[2].sValue != sValueNew):
            Devices[2].Update(sValue = sValueNew)
        ...
        if (Devices[3].sValue != sValueNew):
            Devices[3].Update(sValue = sValueNew)
    ...
    def buildCommandString(self):
        ...
        requestUrl = requestUrl + "&temperature=" + Devices[4].sValue
